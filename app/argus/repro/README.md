...
Qt identity is checked both before and after compiler consumption, and package
objects are rehashed after extraction, so a mutable input cannot retain a
stale admitted receipt.
